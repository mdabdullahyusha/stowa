                ...
                <div class="product_details_image">
                    <div class="details_image_carousel">
                        ...
                        <div class="slider_item">
                            <img src="{{asset('uploads/product/thumbnails')}}/{{$thumbnail->product_thumbnails}}" alt="image_not_found">
                        </div>
                        @endforeach
            ...
            <div class="col-lg-6">
                <div class="product_details_content">
                    ...
                    <div class="item_price">
                        <span>৳<span id="price">{{ $product_info->after_discount}}</span></span>
                        ...
                        <form action="{{ url('cart/insert')}}" method="POST">
                            ...
                            <div class="quantity_wrap">
                                <div class="quantity_input">
                                    ...
                                    <input class="input_number" id="quantity" name="quantity" readonly type="text" value="1">
                                    <button type="button" class="input_number_increment">
                                        <i class="fal fa-plus"></i>
                                    </button>
                                </div>
                                <div class="total_price">Total: ৳ <span id="total">{{ $product_info->after_discount}}</span></div>
                            </div>

                            <ul class="default_btns_group ul_li">
                                @auth('customerlogin')
                                <li><button type="submit" class="btn btn_primary addtocart_btn" href="#">Add To Cart</button></li>
                                @else
                    ...
                    <div class="product-area clearfix row">
                        ...
                        <div class="grid col-lg-3">
                            ...
                            <div class="details">
                                ...
                                <p><a href="{{route('product.details', $related->id)}}">{{substr($related->description, 0, 20)}} </a></p>
                                <div class="rating">
