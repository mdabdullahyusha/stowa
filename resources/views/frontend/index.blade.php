                                ...
                                <div class="product-area clearfix row">
                                    ...
                                    @foreach ($all_product as $product)
                                        <div class="grid col-lg-4">
                                            ...
                                            <div class="details">
                                                <h4><a href="{{ route('product.details', $product->id) }}">{{ substr($product->product_name, 0, 20) }}</a></h4>
                                                ...
                                                <span class="price">
                                                    <ins>
                                                        <span class="woocommerce-Price-amount amount">
                                                            <bdi>
                                                                @if($product->product_discount)
                                                                <span class="woocommerce-Price-currencySymbol"></span><del style="color:;">৳ {{ $product->product_price }}</del>
                                                                @else
                                                                @endif
                                                                &nbsp;
                ...
                <div class="container">
                    ...
                    <div class="row newarrivals_products">
                        ...
                        <div class="col col-lg-7">
                            <div class="new-arrivals-grids clearfix row">
                                        ...
                                        <div class="actions">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <a class="quickview_btn" data-bs-toggle="modal" href="#new_arrival{{ $new->id}}" role="button" tabindex="0"><svg width="48px" height="48px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Visible (eye)</title> <path d="M22 12C22 12 19 18 12 18C5 18 2 12 2 12C2 12 5 6 12 6C19 6 22 12 22 12Z"/> <circle cx="12" cy="12" r="3"/> </svg></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <!-- product quick view modal - start
                                        ================================================== -->
                                        <div class="modal fade" id="new_arrival{{ $new->id}}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalToggleLabel2">Product Quick View</h5>
